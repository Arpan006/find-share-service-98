...
import { Search, MapPin, Calendar, Layers, Filter } from 'lucide-react';
              ...
              <GlassMorphicCard>
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto space-y-3">
                    ...
                    <Button 
                      variant="default" 
                      className="w-full mt-4 bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 border-none"
                    >
                      Claim Item
                    </Button>
                  </div>
