        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-lg text-primary">CommunityConnect</span>
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:contact@communityconnect.com" className="text-muted-foreground hover:text-primary transition-colors">
                <Mail size={20} />
              </a>
            </div>
          </div>
